...
---
<!-- Generated by ybs_shows.py build from .claude/skills/ybs-shows/agents/shows-digest.md.tmpl — edit the template, not this file. -->
...
tens of thousands of words, and no one agent can hold 15 of them.
